export default function SupportPage() {
  const faqs = [
    ...
    },
    {
      ...
      title: "Paiements",
      content:
        "AM STORE accepte plusieurs modes de paiement sécurisés. En cas de problème lors d'un paiement, vérifiez vos informations bancaires ou contactez notre support.",
    },
    {
      icon: "🏪",
